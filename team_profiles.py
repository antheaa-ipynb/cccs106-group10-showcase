...
def get_initial_team() -> List[TeamMember]:
    ...
    members = [
        ...
        # ----------------------------------------------------------------------
        TeamMember(
            student_id="2412208",  # example: "2024-10123"
            full_name="Antoinitte Hernandez", # example: "Maria Clara Santos"
            role="Lead Frontend UI/UX Developer",
            specialization="Flet Reactive Widgets & Material 3 Layouts",
            github_handle="@antheaa-ipynb",          # example: "@mariaclara-cspc"
            avatar_icon=ft.Icons.PALETTE,
            accent_color=ft.Colors.TEAL_700,
            photo_url="/antheaaa.png",                 # Photo: local asset or URL (e.g. "https://github.com/dev1-github.png")
        ),
        # ----------------------------------------------------------------------
        ...
        # ----------------------------------------------------------------------
        TeamMember(
            student_id="2410990",  # example: "2024-10456"
            full_name="Lai Pauline Catangui", # example: "Juan Dela Cruz"
            role="Backend & State Engineer",
            specialization="State Mutation & Event Handlers",
            github_handle="@lacatangui-max",          # example: "@jdelacruz-cspc"
            avatar_icon=ft.Icons.DATA_OBJECT,
            accent_color=ft.Colors.AMBER_800,
            photo_url="/lai.jpg",                 # Photo: local asset or URL (e.g. "https://github.com/dev2-github.png")
        ),
        # ----------------------------------------------------------------------
        ...
        # ----------------------------------------------------------------------
        TeamMember(
            student_id="2411279",  # example: "2024-10789"
            full_name="Thea Ann Pacer", # example: "Angelo Reyes"
            role="QA & Feature Engineer",
            specialization="Testing Diagnostics, Theme Engine & Controls",
            github_handle="@teahBtsenhypentxtand2ble",          # example: "@areyes-cspc"
            avatar_icon=ft.Icons.BUG_REPORT,
            accent_color=ft.Colors.INDIGO_700,
            photo_url="/assets/thea.jpeg",                 # Photo: local asset or URL (e.g. "https://github.com/dev3-github.png")
        ),
    ]
    return members
